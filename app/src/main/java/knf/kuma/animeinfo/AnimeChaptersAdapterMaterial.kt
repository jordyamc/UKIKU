...
class AnimeChaptersAdapterMaterial(private val fragment: Fragment, private val recyclerView: RecyclerView, private val chapters: MutableList<AnimeObject.WebInfo.AnimeChapter>, private val touchListener: DragSelectTouchListener) : RecyclerView.Adapter<AnimeChaptersAdapterMaterial.ChapterImgHolder>(), FastScrollRecyclerView.SectionedAdapter {
            ...
            holder.actions.setOnClickListener { view ->
                ...
                menu.setOnMenuItemClickListener { item ->
                    when (item.itemId) {
                        ...
                        R.id.import_file -> (fragment as ChaptersFragmentMaterial).onMove(chapter.fileName)
                        R.id.commentaries -> {
                            try {
