                    ...
                    .observe(this@FragmentChaptersMaterial, Observer { fileDownObjs ->
                        if (fileDownObjs.isEmpty()) {
                            ...
                            lifecycleScope.launch(Dispatchers.Main) {
                                ...
                                adapter = ExplorerChapsAdapterMaterial(this@FragmentChaptersMaterial, recyclerView, withContext(Dispatchers.IO) { ExplorerObjectWrap(explorerObject) }, clearInterface)
